class Vec2 {
    ...
    add(x, y = undefined, returnNew = undefined) {
    ...
    subtract(x, y = undefined, returnNew = undefined) {
      if (typeof x != 'number') {
        returnNew = y;
        if (Array.isArray(x)) {
          y = x[1];
    ...
    multiply (x, y = undefined, returnNew = undefined) {
      if (typeof x != 'number') {
        returnNew = y;
        if (Array.isArray(x)) {
          y = x[1];
