...
import DifficultyCalculator20140722 from "./DifficultyCalculator.js";

class PPCalculator20140722 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20140722().calculate(beatmap);
    ...
    calculateWithCounts(diff, beatmap, mods = MODS_ENUM.None, combo = -1, misses = 0, c300 = -1, c100 = 0, c50 = 0) {
	    ...
	    aimValue *= 0.95 + 0.4 * Math.min(1.0, totalHits / 2000.0) + (totalHits > 2000 ? Math.log10(totalHits / 2000) * 0.5 : 0.0);
...
export default PPCalculator20140722