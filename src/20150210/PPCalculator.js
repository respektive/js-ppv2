...
import DifficultyCalculator20150210 from "./DifficultyCalculator.js";

class PPCalculator20150210 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20150210().calculate(beatmap);
...
export default PPCalculator20150210