...
import DifficultyCalculator20150212 from "./DifficultyCalculator.js";

class PPCalculator20150212 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20150212().calculate(beatmap);
    ...
    calculateWithCounts(diff, beatmap, mods = MODS_ENUM.None, combo = -1, misses = 0, c300 = -1, c100 = 0, c50 = 0) {
        ...
        if(approachRate > 10.33) {
            approachRateFactor += 0.30 * (approachRate - 10.33);
...
export default PPCalculator20150212