...
import DifficultyCalculator20150216 from "./DifficultyCalculator.js";

class PPCalculator20150216 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20150216().calculate(beatmap);
...
export default PPCalculator20150216