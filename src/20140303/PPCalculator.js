...
import DifficultyCalculator20140303 from "./DifficultyCalculator.js";

class PPCalculator20140303 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20140303().calculate(beatmap);
    ...
    calculateWithCounts(diff, beatmap, mods = MODS_ENUM.None, combo = -1, misses = 0, c300 = -1, c100 = 0, c50 = 0) {
        ...
        // Calculate Aim Value
        // -------------------
        let aimValue = Math.pow(5.0 * Math.max(1.0, aim / 0.0445) - 4.0, 3.0) / 100000;
        ...
        // ---------------------
        let speedValue = Math.pow(5.0 * Math.max(1.0, speed / 0.045) - 4.0, 3.0) / 100000;
...
export default PPCalculator20140303