...
import DifficultyCalculator20140209 from "./DifficultyCalculator.js";

class PPCalculator20140209 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20140209().calculate(beatmap);
...
export default PPCalculator20140209