...
import DifficultyCalculator20140127 from "./DifficultyCalculator.js";

class PPCalculator20140127 {
    ...
    calculate(beatmap, accuracyPercent = 100, mods = MODS_ENUM.None, combo = -1, misses = 0) {
        ...
        const diff = new DifficultyCalculator20140127().calculate(beatmap);
    ...
    calculateWithCounts(diff, beatmap, mods = MODS_ENUM.None, combo = -1, misses = 0, c300 = -1, c100 = 0, c50 = 0) {
        ...
        let accValue = Math.pow(Math.pow(1.3, overallDifficulty) * Math.pow(betterAccuracyPercentage, 15) / 2, 1.6) * 8.3;
	    ...
	    let finalMultiplier = 1.0; // This is being adjusted to keep the final pp value scaled around what it used to be when changing things
        ...
        const totalValue = (aimValue + speedValue + accValue) * finalMultiplier;
...
export default PPCalculator20140127